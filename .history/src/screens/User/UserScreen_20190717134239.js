...
class UserScreen extends PureComponent {
  render() {
    ...
    return (
      <Container>
        <HeaderUser textLeft="Add" textRight="Close" textTitle="User" onButtonLeft={this.onButtonLeft} onButtonRight={this.onButtonRight} />

        <View style={{flex: 1, backgroundColor: R.colors.white100}}>
