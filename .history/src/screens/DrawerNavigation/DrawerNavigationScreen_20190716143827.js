...
class DrawerNavigationScreen extends Component {
    ...
    _renderItem = ({ item }) => {
        return (
            <ListDrawerItem item={item} onChooseScreen={this.onChooseScreen} activeItemKey={this.state.activeItemKey} />
        )
    }
    render() {
        ...
        return (
            <View style={styles.container}>
                <View style={styles.wrapper}>
                    <Text style={styles.textMenu}>LO</Text>
...
const styles = StyleSheet.create({
    ...
    buttonStyle: {
        backgroundColor: R.colors.green655,
