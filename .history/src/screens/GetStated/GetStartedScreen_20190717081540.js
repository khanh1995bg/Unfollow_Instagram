...
import { Text, View, StyleSheet, Dimensions, FlatList, Image, Tou } from 'react-native';
...
export default class GetStartedScreen extends Component {
  ...
  renderItem = ({ item }) => {
    return <View style={styles.container}>
        ...
        {item.total && <Text style={{paddingTop: 10, fontSize: 20, fontWeight: '600'}}>{item.total}</Text>}
    </View>;
  };
}
