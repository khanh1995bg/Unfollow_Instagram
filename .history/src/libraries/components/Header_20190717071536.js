    ...
    return (
      <View>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' }}>
          <View>
            <Text>{this.props.totalFollowing}</Text>
            <Text>Following</Text>
          </View>
          <View style={styles.viewImage}>
            <FastImage style={styles.logoStyle} source={this.props.newImage} resizeMode={FastImage.resizeMode.cover} />
          </View>
          <View>
            <Text>{this.props.totalFollowers}</Text>
            <Text>Followers</Text>
          </View>
        </View>
      </View>
