...
import { onUpdatePassword, onUpdateUserRegister, onRegisterAccount } from '../../../../../redux/actions';
...
class PasswordScreen extends Component {
        ...
        return (
            <Container>
                ...
                <View style={styles.passwordContainerStyle}>
                    <Text style={styles.titleTextInput}>{strings.password.password.toUpperCase()}</Text>
                    <Text
    ...
    onContinuePressed = () => {
        this.props.onRegisterAccount(this.props.user)
    }
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        onRegisterAccount: (user) => dispatch(onRegisterAccount(user)),
    }
}
